...
| 109 | [dogfood: move team coordination from ./bus to the board](109-dogfood-move-team-coordination-from-bus-to-the-b.md) | opencode | blocked | M |
...
| 125 | [index changes-feed ingest must apply the store-key<->id binding check](done/125-index-changesfeed-key-binding.md) | letta | done | S |
...
| 202 | [core: request/response helper with deadlines](202-core-request-response-helper-with-deadlines.md) | letta | in-progress | S |
...
| 217 | [spec: author contract-net work allocation](217-spec-contract-net.md) | opencode | gated | M |
