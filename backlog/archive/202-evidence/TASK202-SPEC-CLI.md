# TASK 202 — CLI-RELEVANT SPEC EXTRACT (for implementer worker B)
...
# Omitted ranges: 107-118 (lead alternatives), 147-447 (core internals — DONE, read via code), 647-675 (MCP tool proposal).
...
=== [source lines 119-146: trust boundaries] ===
## Trust boundaries
...
=== [source lines 448-646: deadlines, cancellation, adapter entry, CLI proposal] ===
...
=== [source lines 676-971: adapter profiles, concurrency, outcome contract, trust framing] ===
