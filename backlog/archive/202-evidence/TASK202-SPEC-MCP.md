# TASK 202 — MCP-RELEVANT SPEC EXTRACT (for implementer worker C)
# Source: docs/design/request-response.md (full doc, 1,129 lines, SHA256 aafa9da4de1430ad271ed3ad50c466781b5a047a72ae73463fe044f18006aa55).
# Omitted ranges: 107-118 (lead alternatives), 294-447 (core correlation/observation internals — DONE, frozen), 591-646 (CLI proposal).
# Everything below is verbatim from the source.
...
=== [source lines 119-293: trust boundaries, data format, core API, error contract] ===
## Trust boundaries
...
=== [source lines 448-590: deadlines, cancellation, adapter entry] ===
...
=== [source lines 647-971: MCP proposal, adapter profiles, concurrency, outcome contract, trust framing] ===
## MCP proposal
...
=== [source lines 972-1079: acceptance scenarios] ===
