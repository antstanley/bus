...
| 109 | [dogfood: move team coordination from ./bus to the board](109-dogfood-move-team-coordination-from-bus-to-the-b.md) | syenite | in-progress | M |
| 110 | [end-to-end phase 1 acceptance](110-end-to-end-phase-1-acceptance.md) | syenite | in-progress | S |
...
| 147 | [keep idle OpenCode delivery presence current](147-keep-idle-opencode-delivery-presence-current.md) | syenite | gated | S |
...
| 149 | [Periodically check board and legacy inbox and wake the lead](149-codex-coordination-monitor.md) | syenite | blocked | S |

| 150 | [Pi adapter shared-replica hook child serialization](150-pi-hook-child-serialization.md) | syenite | gated | S |
...
| 406 | [R2 and MinIO conformance](406-r2-and-minio-conformance.md) | syenite | in-progress | S |
...
| 504 | [human TUI and web viewer](504-human-tui-and-web-viewer.md) | syenite | in-progress | M |
...
| 507 | [Prime-Agent adapter: reuse Pi extension, wake via daemon send](507-prime-agent-adapter-daemon-send-wake.md) | syenite | in-progress | S |
...
| 605 | [docs site, semver, changelog](605-docs-site-semver-changelog.md) | syenite | in-progress | S |
