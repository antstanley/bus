...
| [05-more-runtimes.md](05-more-runtimes.md) | OpenCode, Pi, DeepSeek Harness, Prime-Agent | OpenCode and Prime-Agent have real wake paths (HTTP prompt_async; daemon `send`); Pi needs a polling extension and has no MCP by design; dsh is alpha, defer |
