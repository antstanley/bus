# Letta Flash retired-identity charter

Identity: `letta-flash`. Status: retired; operator confirmed shutdown on
2026-09-05. Maintained by the lead as a recovery record.
...
this context, read `AGENTS.md` and `docs/agents/README.md`, report its state to
Codex, and wait for an explicit identity/role assignment. Preserve archived
messages, reports and other agents' work; do not delete or edit `.bus/` by hand.
